...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
		...
		<tr ><td width="200">保质期：</td><td><input name='baozhiqi' type='text' id='baozhiqi' value='' onblur='' style='border:solid 1px #000000; color:#666666' /></td></tr>
			<tr ><td width="200">价格：</td><td><input name='jg' type='text' id='jg' value='' onblur='' style='border:solid 1px #000000; color:#666666' /></td></tr>
				<tr ><td width="200">详情：</td><td><input name='xq' type='text' id='xq' value='' onblur='' style='border:solid 1px #000000; color:#666666' /></td></tr>
...
function hsgcheck() {
		...
		if(shangpinbianhao==""||(shangpinbianhao.length<6||shangpinbianhao.length>12)){
			 $("#clabelshangpinbianhao").html("<font color=red>药品编号不能为空且长度在3～12位之间！</font>");
			 $("input[id=shangpinbianhao]").focus();
			 $("#querenzhuce").attr("disabled","disabled");
			 return false;
		} 
		else
		{
			$("#clabelshangpinbianhao").html("");
			$.ajax({
				url : "quchongShangpinxinxi.do",
				type : "post",
				data : "shangpinbianhao=" + shangpinbianhao,
				dataType : "json",
				success:function(result){
				if(result.info=="ng"){
					$("#clabelshangpinbianhao").html("<font color=red>药品编号已存在，请更换！</font>");
					$("input[id=shangpinbianhao]").focus();
					$("#querenzhuce").attr("disabled","disabled");
					return false;
				}
				...
				error:function(){
					$("#clabelshangpinbianhao").html("系统异常，请检查错误！");
					$("input[id=shangpinbianhao]").focus();
					$("#querenzhuce").attr("disabled","disabled");
					return false;
				}
