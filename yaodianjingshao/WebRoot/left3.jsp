	...
	<div class="container">
		...
		<div class="leftsidebar_box"><a href="sy.jsp" target="main"><div class="line"><img src="images/coin01.png" />&nbsp;&nbsp;首页</div></a>
			<dl class="system_log">
				...
				<dd>
					<img class="coin11" src="images/coin111.png" /><img class="coin22" src="images/coin222.png" /><a class="cks" href="kehuxinxiList.do" target="main">客户查询</a><img class="icon5" src="images/coin21.png" />
				</dd>
			...
			<dl class="system_log">
				...
				<dd>
					<img class="coin11" src="images/coin111.png" /><img class="coin22" src="images/coin222.png" /><a class="cks" href="caigouList.do" target="main">入库管理</a><img class="icon5" src="images/coin21.png" />
				</dd>
			</dl>
			<dl class="system_log">
				<dt>
				...
				<dd>
					<img class="coin11" src="images/coin111.png" /><img class="coin22" src="images/coin222.png" /><a class="cks" href="xiaoshouList.do" target="main">销售出库管理</a><img class="icon5" src="images/coin21.png" />
				</dd>
			</dl>
