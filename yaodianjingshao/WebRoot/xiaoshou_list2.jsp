...
-->
			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="xiaoshouList2.do" name="myform" method="post">
    ...
    <td>${u.tuihuoyuanyin}</td>
                              ...
                              <td align="center"><a href="doUpdateXiaoshoulb.do?id=${u.id }">退货</a>  </td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <%
			String sql="select * from xiaoshou where xiaoshouyuan='"+(String)request.getSession().getAttribute("username")+"'  ";
...
while(RS_result.next()){
		...
		共计出库数量:<%=xiaoshoushuliangz%>； 
		 ...
		 <c:if test="${page.page>1}">
              <a href="xiaoshouList2.do?page=1" >首页</a>
             <a href="xiaoshouList2.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="xiaoshouList2.do?page=${page.page+1 }">下一页</a>
			<a href="xiaoshouList2.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
