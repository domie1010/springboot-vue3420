...
function gows()
{
	document.location.href="xiaoshou_add.jsp?id=<%=id%>&shangpinbianhao="+document.form1.shangpinbianhao.value;
}
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="addXiaoshou.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">添加出库</td>
						</tr>
