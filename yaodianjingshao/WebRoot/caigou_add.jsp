...
function gows()
{
	document.location.href="caigou_add.jsp?id=<%=id%>&shangpinbianhao="+document.form1.shangpinbianhao.value;
}
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="addCaigou.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">添加入库</td>
						</tr>
		...
		<tr ><td width="200">供应商：</td><td><select name='gongyingshang' id='gongyingshang' style=' height:19px; border:solid 1px #000000; color:#666666'><%=connDbBean.hsggetoption("gongyingshangxinxi","gongyingshang")%></select></td></tr>
		<tr ><td width="200">入库数量：</td><td><input name='caigoushuliang' type='text' id='caigoushuliang' value='' onblur='checkform()' style='border:solid 1px #000000; color:#666666' />&nbsp;<label id='clabelcaigoushuliang' />必需数字型</td></tr>
		<tr ><td width="200">批次：</td><td><input name='caigoushijian' type='text' id='caigoushijian' value='' onblur='' readonly='readonly' style='width:100px; height:16px; border:solid 1px #000000; color:#666666'/></td></tr>
		<tr ><td width="200">入库员：</td><td><input name='caigouyuan' type='text' id='caigouyuan' onblur='' style='border:solid 1px #000000; color:#666666' value='<%=(String)request.getSession().getAttribute("username")%>' readonly="readonly" /></td></tr>
		...
		<tr style='display:none'><td width="200">退货原因：</td><td><textarea name='tuihuoyuanyin' cols='50' rows='5' id='tuihuoyuanyin' onblur='' style='border:solid 1px #000000; color:#666666' ></textarea></td></tr>
...
%>
<script language="javascript">
document.form1.shangpinbianhao.value="<%=connDbBean.readzd("shangpinxinxi","shangpinbianhao","shangpinbianhao",request.getParameter("shangpinbianhao"))%>";
document.form1.shangpinmingcheng.value="<%=connDbBean.readzd("shangpinxinxi","shangpinmingcheng","shangpinbianhao",request.getParameter("shangpinbianhao"))%>";
document.form1.leibie.value="<%=connDbBean.readzd("shangpinxinxi","leibie","shangpinbianhao",request.getParameter("shangpinbianhao"))%>";
document.form1.kucun.value="<%=connDbBean.readzd("shangpinxinxi","kucun","shangpinbianhao",request.getParameter("shangpinbianhao"))%>";
