...
function gows()
{
	document.location.href="yuangong_add.jsp?id=<%=id%>";
}
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateYuangong.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改员工<input type="hidden" name="id" value="${yuangong.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.gonghao.value='${yuangong.gonghao}';</script>	<script language="javascript">document.form1.mima.value='${yuangong.mima}';</script>	<script language="javascript">document.form1.xingming.value='${yuangong.xingming}';</script>	<script language="javascript">document.form1.xingbie.value='${yuangong.xingbie}';</script>	<script language="javascript">document.form1.lianxishouji.value='${yuangong.lianxishouji}';</script>	<script language="javascript">document.form1.dizhi.value='${yuangong.dizhi}';</script>	
					 </table>
			</form>
   </body>
</html>
