...
-->
						...
						<tr align="left" >
							<td colspan="17">
								<form action="allusersList.do" name="myform" method="post">
									查询   用户名：<input name="username" type="text" id="username" style='border:solid 1px #000000; color:#666666' size="12" /> 
									<input type="submit" value="查询" />
								<input type=button name=Submit54 value=添加 onClick="javascript:location.href='allusers_add.jsp'" /></form>								</td>
						</tr></table>
					  </td>
			    </tr>
    ...
    <td>${u.cx}</td>
                              ...
                              <td align="center"><a href="doUpdateAllusers.do?id=${u.id }">编辑</a> | <a href="deleteAllusers.do?id=${u.id }"
