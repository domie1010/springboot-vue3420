...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateShangpinleibie.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改药品类别<input type="hidden" name="id" value="${shangpinleibie.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.leibie.value='${shangpinleibie.leibie}';</script>
