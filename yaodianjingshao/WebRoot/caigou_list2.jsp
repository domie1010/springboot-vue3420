...
-->
			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="caigouList2.do" name="myform" method="post">
									查询   药品编号：<input name="shangpinbianhao" type="text" id="shangpinbianhao" style='border:solid 1px #000000; color:#666666' size="12" />  药品名称：<input name="shangpinmingcheng" type="text" id="shangpinmingcheng" style='border:solid 1px #000000; color:#666666' size="12" />  类别：<input name="leibie" type="text" id="leibie" style='border:solid 1px #000000; color:#666666' size="12" /> 供应商：<select name='gongyingshang' id='gongyingshang' style='border:solid 1px #000000; color:#666666;'><option value="">所有</option><%=connDbBean.hsggetoption("gongyingshangxinxi","gongyingshang")%></select>  批次：<input name="caigoushijian1" type="text" id="caigoushijian1"  value='' onClick="WdatePicker({'dateFmt':'yyyy-MM-dd'})" style='width:80px; height:20px; border:solid 1px #000000; color:#666666' />-<input name="caigoushijian2" type="text" id="caigoushijian2"  value='' onClick="WdatePicker({'dateFmt':'yyyy-MM-dd'})" style='width:80px; height:20px; border:solid 1px #000000; color:#666666' />
    ...
    <td>${u.tuihuoyuanyin}</td>
                              ...
                              <td align="center"><a href="doUpdateCaigoulb.do?id=${u.id }">退货</a> </td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <%
			String sql="select * from caigou where caigouyuan='"+(String)request.getSession().getAttribute("username")+"'  ";
...
while(RS_result.next()){
		...
		共计入库数量:<%=caigoushuliangz%>； 
		 ...
		 <c:if test="${page.page>1}">
              <a href="caigouList2.do?page=1" >首页</a>
             <a href="caigouList2.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="caigouList2.do?page=${page.page+1 }">下一页</a>
			<a href="caigouList2.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
